...
extension AWMViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "AWMDataCell") as! AWMTableViewCell
...
class AWMViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "AWM Data"
    }
    ...
    func createArray() -> [weaponsData] {
        ...
        let Data1 = weaponsData(title: "Damage", data: 105)
